...
const BASE_WORLD_PHASES = [
  ...
  },
  {
    id: 5,
    slug: "quantum",
    heroLabel: "quantum-lattice",
    accent: "#00ffee",
    copy: {
      eyebrow: "Phase VI · Quantum Consciousness",
      title: "The Microtubule",
      subtitle: "Orchestrated objective reduction",
      body: "Consciousness collapses from quantum superposition into deterministic thought — a lattice of tubulin firing in synchronized waves across the void.",
    },
    previewCamera: {
      position: [0, 0, 8],
      lookAt: [0, 0, 0],
    ...
    materialGrade: createMaterialGrade({
      ...
      coreEmissive: "#00ffee",
      shellColor: "#00ccff",
      shellEmissive: "#00ffee",
      conduitColor: "#3300aa",
      membraneColor: "#00ccff",
      uiColor: "#00ffee",
      emissiveBoost: 2.0,
    }),
    lightingRig: {
...
const PHASE_VISUAL_META: Record<string, PhaseVisualMeta> = {
  ...
  quantum: {
    ...
    compositionZone: {
      heroOffset: [0, 0, -0.5],
      uiOffset: [-2.4, -1.5, 0.4],
      safeRadius: 3.0,
    },
    visualQa: {
      expectedHeroAsset: "dark_star",
      approvedSupportLayers: ["scaffold-lattice", "void-particles", "neural-firing"],
